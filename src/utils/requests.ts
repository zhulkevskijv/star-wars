...
export const getPage = <Type,>(url:string) :Promise<SWAPIResult<Type> | void> => swapi.get(url)
...
export const getAllPages  = async <Type,>(url : string, processResults : (results:Array<Type>) => void) => {
